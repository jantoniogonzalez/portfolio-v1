...
export default function Hero({id, setIsTitleHovered, setIsSubtitleHovered}) {
    ...
    const cityWritingContainer = {
        hidden: { opacity: 0, y: "2rem", x: "5rem"},
        show: {
            opacity: 1,
            transition: {
                delay: 0.15,
    ...
    return (
        <div id={id} className="h-[100vh] grid grid-cols-1 items-center justify-center overflow-x-hidden">
            ...
            >
                ...
                <div className="w-full flex justify-center items-center">
                    <div
                        className="absolute w-full flex justify-center text-center pointer-events-none"
                    >
                        <motion.div
                            className="relative font-handwriting text-[2rem] text-[#c32d27]"
                            variants={cityWritingContainer}
                            initial="hidden"
                            animate={isCityHovered ? "show" : "hidden"}
                        >
                            {
                                "Oh Canadaaaaa!".split("").map((letter , id) => {
                                    return (
                                        <motion.span
                                            className="whitespace-pre"
                                            variants={cityWritingItem}
                                            key={id}
                                        >
                                            {letter}
                                        </motion.span>
                    ...
                    <motion.h3
                        onMouseEnter={() => {setIsSubtitleHovered(true); setIsCityHovered(true);}}
                        onMouseLeave={() => {setIsSubtitleHovered(false); setIsCityHovered(false);}}
                        className="flex text-[2rem] tracking-tight text-center whitespace-pre text-white w-fit "
                        variants={titleItem}
                    >
                        Based in <motion.div
                            initial={{textDecorationLine: "none"}}
                            animate={isCityHovered ? { textDecorationLine: "underline"} : { textDecorationLine: "none"}}
                            transition={{
                                delay: 0.15,
                                type: "tween",
                                duration: 0.5,
                            ...
                            style={{ textDecorationColor: "#c32d27", textDecorationThickness: "0.2rem" }}>
                            Vancouver, BC
                        </motion.div>
                    </motion.h3>
                </div>
                ...
                <motion.div
                    className="flex mt-[2rem] gap-x-[2rem] mb-[1rem] justify-center w-full relative z-[0]"
                    variants={titleItem}
                >
                    <GsapMagnetic>
                        <a
                        ...
                        >
                            <svg className="p-3 w-[7rem] h-[7rem] fill-white stroke-white hover:stroke-[#f5c63f] hover:fill-[#f5c63f]" width="80" height="100" fill="none" viewBox="2 -12 60 85" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <GsapMagnetic>
                        <a
                            ...
                            onMouseLeave={() => {setIsSubtitleHovered(false)}}
                        >
                            <svg className="p-5 w-[7rem] h-[7rem] fill-white hover:fill-[#356fdb]" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="80" height="100" viewBox="0,0,250,250">
                    ...
                    <GsapMagnetic>
                        <a
                            ...
                            onMouseLeave={() => {setIsSubtitleHovered(false)}}
                        >
                            <svg className="p-5 w-[7rem] h-[7rem] fill-white hover:fill-[#c32d27]" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="80" height="100" viewBox="0,0,250,250">
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-white text-[1.25rem]">Scroll To Explore</p>
                    </Link>
                </motion.div>
            </motion.div>            
        </div>
