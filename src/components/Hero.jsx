    ...
    return (
        <div className="h-[100vh] bg-[#222222] grid grid-cols-1 items-center justify-center">
            ...
            >
                ...
                >
                    <GsapMagnetic>
                        <svg className="p-3 mx-[1vw] w-[7rem] h-[7rem] fill-white stroke-white hover:stroke-[#f5c63f] hover:fill-[#f5c63f]" width="80" height="100" fill="none" viewBox="-5 -1 80 80" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <GsapMagnetic>
                        <svg className="p-3 mx-[1vw] w-[7rem] h-[7rem] fill-white hover:fill-[#356fdb]" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="80" height="100" viewBox="0,0,300,300">
                    ...
                    <GsapMagnetic>
                        <svg className="p-3 mx-[1vw] w-[7rem] h-[7rem] fill-white hover:fill-[#c32d27]" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="80" height="100" viewBox="0,0,300,300">
